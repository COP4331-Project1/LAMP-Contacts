...
function gettingStarted(userName){
    ...
    +"<div class='time'>"
		...
		+ "<script> var dt = new Date(); var hr = dt.getHours(), pe = 'AM', min = dt.getMinutes() ; console.log(hr.padStart(2, '0')); console.log(min.padStart(2, '0')); if(hr == 0){ hr = 12;} if(hr > 12){ hr = hr - 12; pe='PM';} document.getElementById('hour').innerHTML = hr; document.getElementById('minutes').innerHTML= min; document.getElementById('seconds').innerHTML = dt.getSeconds(); document.getElementById('period').innerHTML = pe; </script>"
    +"</div>"
	+"</div>"
    + "</div>"
