...
function createInfoBoxes(contactFirstName,contactLastName,address,phoneNumber,email,CID,dateCreated) { //Shows the contact information when clicked on
	...
	+ "<div class='input-group mb-1'>" + "<input type='text' class='form-control' id = 'contactFirstNameText' onchange = update('"+field+"','"+CID+"') aria-describedby='inputGroup-sizing-default'>"
	"</div>"
	"</div> " +
